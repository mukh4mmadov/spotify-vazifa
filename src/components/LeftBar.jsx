            ...
            <nav className="pt-16 pl-7 pr-12">
                <ul className="space-y-4">
                    {[
                        ...
                        { icon: FcLike, label: "Liked Songs" },
                    ].map(({ icon: Icon, label }, index) => (
                        <li key={index} className="hover:opacity-90 duration-200 flex items-center gap-5 border-l-4 border-transparent hover:border-l-[#1DB954] pl-2">
